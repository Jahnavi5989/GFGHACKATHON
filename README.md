...
- Containerization:
Create a Docker image of the backend application, which includes the React app and Nginx web server configurations.
Use a multi-stage Dockerfile to build the backend app and copy the static assets to the Nginx web server.
- Deployment:
...
Store the static assets, such as images, CSS files, and JavaScript files, in an Gcloud bucket
